...
namespace template
{
    public class Scene
    {
        ...
        public Scene()
        {
                AddSphere(1.5f, new Vector3(-3.5f, 0f, 2f), new Vector3(1, 0, 0));
                AddSphere(1.5f, new Vector3(0, 0f, 2f), new Vector3(0, 1, 0));
                AddSphere(1.5f, new Vector3(3.5f, 0f, 2f), new Vector3(0, 0, 1));
        }
